...
-   **I. Easy/Automated End-User Experience**: **PASS** - Plan emphasizes IaC and automation for setup and deployment. Nomad job files provide declarative application definitions. Single-command engineer experience via wrapper scripts. WireGuard client configs are auto-generated by the IaC.
...
1.  **Data Model** (`data-model.md`):
    -   Define entities: Physical Host, Virtual Machine, Nomad Cluster, Nomad Job, Docker Container, WireGuard Server, WireGuard Peer, Reverse Proxy, NAT Network, Media Application Config.
